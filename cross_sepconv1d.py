...
cross_modelpath = r"D:\IDL_PROJECT_DATA\CNN_Graph_ON_SMALLP300\p300-less\models\sepconv1d\cross"
...
auc_file = os.path.join(cross_modelpath, "aucs.npy")  # ✅ Ensure we pass a file, not a folder
plot_cross_aucs(auc_file, os.path.join(cross_modelpath, "sepconv1d_cross_auc.png"), "SepConv1d - Cross")
